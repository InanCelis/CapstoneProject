...
Route::group(['middleware' => ['auth', 'admin', 'status']], function(){
   ...
   //generate anual report
   Route::get('/anualreport', 'Admin\DashboardController@anual');
   Route::post('/anualreport', 'Admin\DashboardController@anual');

   //generate monthly report
   Route::get('/monthlyreport', 'Admin\DashboardController@monthly');
   Route::post('/monthlyreport', 'Admin\DashboardController@monthly');

   //generate daily report
   Route::get('/dailyreport', 'Admin\DashboardController@daily');
   Route::post('/dailyreport', 'Admin\DashboardController@daily');
  ...
  //updating status of an applicant in registration of all event
   ...
   //makeadmin
   Route::get('/makeadmin/{id}', 'Admin\SettingController@makeAdmin');
   //makenormaluser
   Route::get('/makenormaluser/{id}', 'Admin\SettingController@makeNormalUser');
   
  


  //audit trails
   Route::get('/audit-trails', 'Admin\AuditTrailController@index');
   ...
   Route::get('/admin/generate-report/event/for-screening/{id}', 'Admin\GenerateReportController@eventForauditionReport');
   Route::get('/admin/generate-report/event/contestant/{id}', 'Admin\GenerateReportController@eventcontestantReport');
