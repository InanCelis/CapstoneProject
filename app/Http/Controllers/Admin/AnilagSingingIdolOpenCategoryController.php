...
class AnilagSingingIdolOpenCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.anilag_singing_idol_open', compact('year', 'event', 'notifications'))->with('pagename', 'Anilag Singing Idol (Open Category)');   
    }
}
