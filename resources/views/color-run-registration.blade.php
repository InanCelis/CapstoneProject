      ...
      @if($event_status == 'open')
    	<div class="row ">
          ...
          @if(session('success'))
           ...
           @endif
    			<form action="{{ route('color_run_register') }}" method="POST" enctype="multipart/form-data" id="registerform">
    				@csrf
            @auth
            @foreach($user as $user)
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label " for="middle_name">Middlename</label>
                    <div class="input-group input-group-alternative mb-4">
                      <input class="form-control form-control-alternative bg-white" id="middle_name" placeholder="Middlename" type="text" name="middle_name"  value="{{ $user->middle_name }}" readonly >
                    </div>
                    @if($errors->has('middle_name'))
                    <span class="my--5" role="">
                      <strong class="text-danger text-sm">{{ $errors->first('middle_name') }}</strong>
                    </span>
                   @endif
                 </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                 ...
                 <div class="accordion" id="accordionExample">
                    <div class="card">
                        <div class="card-header bg-secondary" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                            <h5 class="mb-0">Waiver<i class="fas fa-chevron-down pull-right"></i></h5>
                        </div>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <p>This is to attest and certify that the organizers are not LIABLE to any untoward incidents that might happen during the ANILAG COLOR RUN {{ date('Y') }}</p>
                            </div>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" name="terms" value="1" {{ !old('terms') ?: 'checked' }} id="terms" >
                              <label class="custom-control-label" for="terms">I have read and agree to the Terms</label>
                            </div>
                        </div>
                    </div>
                     @if($errors->has('terms'))
                        <span class="my--5" role="">
                          <strong class="text-danger text-sm">{{ $errors->first('terms') }}</strong>
                        </span>
                      @endif  
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label " for="middle_name">Middlename</label>
                    <div class="input-group input-group-alternative mb-4">
                      <input class="form-control form-control-alternative bg-white" id="middle_name" placeholder="Middlename" type="text" name="middle_name"  value="{{ old('middle_name') }}"  >
                    </div>
                    @if($errors->has('middle_name'))
                    <span class="my--5" role="">
                      <strong class="text-danger text-sm">{{ $errors->first('middle_name') }}</strong>
