                         ...
                         <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="/admin/pdf/laguna-gay-queen/{{ $event_1->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
           ...
           <div class="row">
            ...
            <div class="card shadow">
               <div class="card-header border-0">
                ...
                <a href="/admin/generate-report/event/for-screening/7" target="_blank" class="btn btn-success pull-right"><i class="fas fa-table"></i> Generate Report</a>
               ...
               <div class="table-responsive container">
                      ...
                      <tr>
                         ...
                         <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/laguna-gay-queen/{{ $event_2->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                 ...
                 <button type="button" class="btn btn-sm  bg-gradient-default text-white showsmsmodal" id="7">
           ...
           <div class="row">
            ...
            <div class="card shadow">
               <div class="card-header border-0">
                ...
                <a href="/admin/generate-report/event/contestant/7" target="_blank" class="btn btn-success pull-right"><i class="fas fa-table"></i> Generate Report</a>
                      ...
                      <tr>
                         ...
                         <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/laguna-gay-queen/{{ $event_3->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                      ...
                      <tr>
                         ...
                         <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/laguna-gay-queen/{{ $event_4->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
