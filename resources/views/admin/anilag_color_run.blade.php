                             ...
                             <td class="text-right">
                               <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="/admin/pdf/anilag-color-run/{{ $event_2->id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                                  </div>
                               </div>
                             </td>
                          </tr>
                        ...
                        <tr>
                           ...
                           <td class="text-right">
                             <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  <a class="dropdown-item" href="/admin/pdf/anilag-color-run/{{ $event_1->id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                                </div>
                             </div>
                           </td>
