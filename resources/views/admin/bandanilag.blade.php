                      ...
                      <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="/admin/pdf/bandanilag/{{ $event_1->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
         ...
         <div class="row">
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <a href="/admin/generate-report/event/for-screening/5" target="_blank" class="btn btn-success pull-right"><i class="fas fa-table"></i> Generate Report</a>
            ...
            <div class="table-responsive container">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/bandanilag/{{ $event_2->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                                <hr class="my-1">
                                <small>&nbsp;<i class="far fa-question-circle text-dark"></i> Move to</small>
              ...
              <button type="button" class="btn btn-sm  bg-gradient-default text-white showsmsmodal" id="5">
         ...
         <div class="row">
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <a href="/admin/generate-report/event/contestant/5" target="_blank" class="btn btn-success pull-right"><i class="fas fa-table"></i> Generate Report</a>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/bandanilag/{{ $event_3->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                                <hr class="my-1">
                                <small>&nbsp;<i class="far fa-question-circle text-dark"></i> Move to</small>
                    ...
                    <tr>
                                  ...
                                  <tbody> 
                                    ...
                                    @foreach($event_4->tbl_event_member as $member)
                                      <tr> 
                                        ...
                                        <td>
                                          <a href="{{ asset('/user_id_picture') }}/{{ $member->member_id_picture }}" target="_blank">
                                          <img src="{{ asset('/user_id_picture') }}/user_id_picture/{{ $member->member_id_picture }}" height="40px" width="40px" style="border: 1px solid gray"></a>
                                        </td>
                                      </tr>
                                     @endforeach
                      ...
                      <td class="text-right">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <h5 class="navbar-heading text-muted"><center>Action</center></h5>
                                <a class="dropdown-item" href="/admin/pdf/bandanilag/{{ $event_4->user_id }}" target="_blank"><i class="far fa-file-pdf text-success"></i>View pdf</a>
                                <hr class="my-1">
                                <small>&nbsp;<i class="far fa-question-circle text-dark"></i> Move to</small>
