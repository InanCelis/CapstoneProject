	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<h1>5<span><img src="{{ asset('/pageicon/yda.png') }}" height="120px" width="120px" class="image"></span>0</h1>
			</div>
			<span class="oops">Internal Server Error</span><p>Something went wrong :(</p>
