	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<h1>4<span><img src="{{ asset('/pageicon/yda.png') }}" height="130px" width="130px" class="image"></span>4</h1>
			</div>
			<span class="oops">Not Found</span><p>The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
