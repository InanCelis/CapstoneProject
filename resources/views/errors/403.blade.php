	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<h1>4<span><img src="{{ asset('/pageicon/yda.png') }}" height="130px" width="130px" class="image"></span>3</h1>
			</div>
			<span class="oops">Access Denied/Forbidden</span><p>The page or resource you were trying to reach is absolutely forbidden for some reason.</p>
