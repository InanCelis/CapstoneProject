           ...
           @if($event_user_status-> count() > 0)
              <div class="card bg-white shadow">
                <div class="card-body">
                  ...
                  <a href="{{ route('mardi_gay.pdf') }}" target="_blank" class="btn btn-sm  btn-dark" ><i class="far fa-file-pdf text-danger"></i> PDF Application Form</a><br> <small>Congratulations! Please click the button to download your form and bring it on the audition time. This will disappear when the admin removes it.</small> 
                </div>
              </div>
           @endif
              ...
              <div class="col-xl-12 order-xl-1">
                <div class="card bg-white shadow">
                    <div class="card-body">
                      ...
                      <form id="mardigay_form" method="POST" enctype="multipart/form-data">
                          @csrf
                          <p id="form_result"></p>
                          <input type="hidden" name="form_name" id="form_name" value=" {{ __('#mardigay_form') }}">
                          <input type="hidden" name="route_name" id="route_name" value=" {{ route('mardi-gay.store')}}">
                          <div class="row">
                           <div class="col-lg-12">
                            <center>
                                <label class="heading-large text-center  mb-4">ENTRY APPLICATION FORM</label>
                                <h2 class="heading-large text-center  mb-4">MARDI GAY QUEEN</h2>
                            </center>
                           </div>
                          </div>
                          <div class="pl-lg-4" id="reloadpage">
                            <div class="row">
                                <div class="col-md-8">
