   ...
   <div class="header  pb-8 pt-5 pt-md-8">
     <div class="container-fluid">
      <div class="header-body" style="margin-top: -35px">
       YDA - Laguna / {{ $pagename }} / Renewal Applicant<br>
      </div>
     </div>
   </div>
   <!-- Page content -->
            ...
            <div class="card-body" id="refresh">
                ...
                @if(count($accreditation))
                  ...
                  @foreach($user as $user_info)
                    ...
                    @if($accreditation->status == 2 || $accreditation->status == 3)

                      <h2 class="heading-large text-center  mb-4">RENEWAL APPLICATION FOR ACCREDITATION</h2><br>
                      <form id="renewal_accreditation" method="POST" enctype="multipart/form-data">
                          @csrf
                        <div id="reload">
                          <div class="pb-6 my--5">
                            @if($accreditation->status == 2)
                              <h3 class="text-center text-danger">(accreditation expired)</h3>
                            @elseif($accreditation->status == 3)
                              <h3 class="text-center text-danger">(for approval)</h3>
                            @endif
                          </div>
                          <div class="row">
                              <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative mb-4">
                                      <input class="form-control form-control-alternative bg-white" placeholder="Name of Organization" type="text" readonly id="organization"  value="{{ $accreditation->name }}">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-5">
                          ...
                          <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative mb-4">
                                      <input class="form-control form-control-alternative bg-white" placeholder="Town/Origin" type="text" readonly id="town" value="{{ $accreditation->town }}" >
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative mb-4">
                                      <input class="form-control form-control-alternative bg-white" placeholder="Type of Organization" type="text" readonly id="type"  value="{{ $accreditation->type }}">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative mb-4">
                                      <input class="form-control form-control-alternative bg-white" placeholder="Number of Members" type="number" name="number_of_members" id="members"  value="{{ $accreditation->member }}">
                                    </div>
                                 </div>
                              </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->letter_of_intent }}" class="text-center">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->organizational_structure }}" class="text-center">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->roster_of_member }}" class="text-center">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->organizational_profile }}" class="text-center">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->bylaws }}" class="text-center">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center bg-secondary">
                                  <a href="/accreditation_file/{{ $accreditation->program_and_project }}" class="text-center">
                     ...
                     @elseif($accreditation->status == 1
                      ...
                      @elseif($accreditation->status == 0)

                      <h2 class="text-center text-danger">You are not yet accredited to renew.</h2> 
