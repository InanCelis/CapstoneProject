           ...
           @if($event_user_status-> count() > 0)
              <div class="card bg-white shadow">
                <div class="card-body">
                  ...
                  <a href="{{ route('lesbian_king.pdf') }}" target="_blank" class="btn btn-sm  btn-dark" ><i class="far fa-file-pdf text-danger"></i> PDF Application Form</a><br> <small>Congratulations! Please click the button to download your form and bring it on the audition time. This will disappear when the admin removes it.</small> 
                </div>
              </div>
           @endif
           ...
           <div class="col-xl-12 order-xl-1">
              <div class="card bg-white shadow">
                <div class="card-body">
                  ...
                  <form id="laguna_lesbian_king" method="POST" enctype="multipart/form-data">
                     @csrf
                     <input type="hidden" name="form_name" id="form_name" value=" {{ __('#laguna_lesbian_king') }}">
                     <input type="hidden" name="route_name" id="route_name" value=" {{ route('laguna-lesbian-king.store')}}">
                     <div class="row">
                      <div class="col-lg-12">
                       <center>
                          <label class="heading-large text-center  mb-4">ENTRY APPLICATION FORM</label>
                          <h2 class="heading-large text-center  mb-4">LAGUNA LESBIAN KING {{ $currentyear = date('Y') }}</h2>
                       </center>
                      </div>
                     </div>
                          ...
                          <div class="row">
                           <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <div class="input-group input-group-alternative mb-4">
                                 <input required class="form-control form-control-alternative bg-white" accept="image/*"  type="file" readonly id="id_picture" name="id_picture" >
                              </div>
                             </div>
